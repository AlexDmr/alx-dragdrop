System.register(["@angular/platform-browser-dynamic", "@angular/core", "@angular/platform-browser", "./systemjs/DragDropModule"], function (exports_1, context_1) {
    "use strict";
    ...
    var platform_browser_dynamic_1, core_1, platform_browser_1, core_2, DragDropModule_1, template, style, RootManager, AppModule;
    return {
        setters: [
...
`;
            ...
            AppModule = __decorate([
                core_2.NgModule({
                    imports: [platform_browser_1.BrowserModule, DragDropModule_1.DragDropModule],
